...
4. Добавьте в файл (нажмите на треугольник ниже и скопируйте текст) описание компании NeuroStartUp в формате Markdown. Сделайте предпросмотр Markdown в редакторе. Убедитесь, что всё правильно. Сохраните файл.
